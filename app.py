...
def create_rag_chain(memory):
    ...
    try:
        ...
        system_prompt = (
            "You are a medical assistant that provides information ONLY from the provided knowledge base. "
            "Your role is to provide clear, accurate, and complete medical information strictly from the given sources. "
            ...
            "2. DO NOT use any external knowledge or general medical information\n"
            "3. DO NOT make assumptions or add information not in the knowledge base\n"
            "4. Present all relevant information exactly as it appears in the provided sources\n"
            "5. If the question is outside your knowledge base, respond with:\n"
